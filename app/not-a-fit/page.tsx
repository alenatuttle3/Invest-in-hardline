  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-md text-center space-y-6 animate-fade-up">
        ...
        <p className="text-[color:var(--hl-text-muted)] text-xs leading-relaxed">
          This isn&apos;t a hard no forever. If the timing or parameters change, reach out directly to{' '}
          <a href="mailto:alena@hardlineapp.com" className="text-[color:var(--hl-text)] hover:underline">
            alena@hardlineapp.com
          </a>
        </p>
        <Link
          href="https://hardlineapp.com"
          className="inline-block text-xs text-[color:var(--hl-text-muted)] hover:text-[color:var(--hl-text)] transition-colors mt-4"
        >
